<template>
  <div class="home">
    <yandex-map :coords="coords" :zoom="10" :settings="settings" :controls="controls" @click="onClick" 
    @map-was-initialized="init">
      <!-- <ymap-marker :coords="coords" marker-id="123" hint-content="some hint"/> -->
      <ymap-marker :coords="coordsMkad" marker-id="mkad" hint-content="granicy mkad" marker-type="Polygon"/>
    </yandex-map>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      settings: { lang: 'en_US', apiKey: '95c03f43-0880-4b84-84d5-e4daefbb07a9' },
    };
  },
  async mounted() {
  ...
  methods: {
    init(map) {
      ...
      this.myymap = map;
      window.myymap = map;
      var polygon = new ymaps.Polygon(this.coords);

this.myymap.addOverlay(polygon);
    },
    onClick(e) {
      this.coords = e.get('coords');
      let point = e.get('coords');
      let polygon = this.myymap;
    },
  },
};
